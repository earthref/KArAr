...
c.collections['karar.private.contributions'] = new Mongo.Collection('karar.private.contributions');
c.collections['karar.import.settings.templates'] = new Mongo.Collection('karar.import.settings.templates');
c.collections['karar.import.settings.templates.subscription'] = new Mongo.Collection('karar.import.settings.templates.subscription');
