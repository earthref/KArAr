...
levels[1].views = [ { name: 'Summaries', es: { index: index, type: 'sites'        , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'sites'        + '.*', 'summary._all.*']} }} ,
//                    { name: 'Sites Map', es: { index: index, type: 'sites'        , source: {excludes: [                           ], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'sites'        + '.*', 'summary._all._geo_point']} }} ,
...
levels[2].views = [ { name: 'Summaries', es: { index: index, type: 'samples'      , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'samples'      + '.*', 'summary._all.*']} }} ,
...
levels[3].views = [ { name: 'Summaries', es: { index: index, type: 'specimens'    , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'specimens'    + '.*', 'summary._all.*']} }} ,
...
levels[4].views = [ { name: 'Summaries', es: { index: index, type: 'experiments'  , source: {excludes: ['*.vals', '*._geo_envelope'], includes: ['summary._incomplete_summary', 'summary.contribution.*', 'summary.' + 'experiments'  + '.*', 'summary._all.*']} }} ,
