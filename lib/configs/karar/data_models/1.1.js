...
export const model = {
   ...
   'contribution':{
      ...
      'columns':{
         ...
         'timestamp':{
            ...
            'examples':[
               '2021-01-01T10:02:34.87',
               '2020-07-20T22:56:15-04:00'
            ],
            'validations':[
               'downloadOnly()'
            ]
   ...
   'samples':{
      ...
      'notes':'Field samples or discrete samples from a section of core. Generally all of one sample is the sample age.',
      'columns':{
         'contribution_id':{
            'label':'Contribution ID',
            'group':'Contribution',
         ...
         'igsn':{
            ...
            'position':3,
            'type':'String',
            'description':'International Generic Sample Number (IGSN) of the sample. See https://support.datacite.org/docs/about-igsn-ids-for-material-samples',
            'validations':[
               'type("igsn")',
               'required()'
            ]
         ...
         'result_quality':{
            ...
            'notes':'Can be left empty. This is the case for many legacy data sets. Generally reported results are good but can be left blank if the quality type was not checked.',
            'examples':[
               'g',
               'b'
            ],
         ...
         'settings':{
            ...
            'position':8,
            'type':'List',
            'description':'Colon-delimited list of geologic, archeological, or astronomical settings/classifications',
            'examples':[
               'Igneous',
               'Sedimentary',
               'Submarine',
         ...
         'composite_depth':{
            ...
            'notes':'Meters below seafloor of a model of the depth based on multiple cores '
         },
         'description':{
            'label':'Description',
            'group':'Metadata',
            ...
            'examples':[
               'This sample was taken 130 cm from a 40 cm thick dike'
            ]
         },
         'instrument_codes':{
         ...
         'source_dataset':{
            ...
            'position':32,
            'type':'String',
            'description':'Data DOI or URL pointing to the source of the dataset if KArAr is not the orignal source of the data',
            'examples':[
               'Geochron[IESS10095]'
            ],
            'validations':[
   ...
   'specimens':{
      'label':'Specimens',
      'position':3,
      'description':'Sub-samples, sample splits, or mineral separates measured',
      ...
      'columns':{
         ...
         'project':{
            ...
            'examples':[
               'Lisa Tauxe - Antarctica dry valleys volcanics'
            ]
         },
         'age':{
            'label':'Age',
         ...
         'age_internal_one_sigma_stderr':{
            ...
            'notes':'Uncertainties in measurements and flux monitor values, but not external uncertainties, are included.',
            'examples':[
               '0.23',
               '25'
            ]
         ...
         'age_low':{
            ...
            'notes':'Used for asymmetrical age uncertainties often calculated using Bayesian statistics when one has additional age constraints on the age of the site.',
            'examples':[
               '120.2',
               '505',
               '5.43'
         ...
         'age_high':{
            ...
            'type':'Number',
            'unit':'Custom',
            'description':'Sample oldest age constraint. Used for asymmetrical age uncertainties often calculated using Bayesian statistics when one has additional age constraints on the age of the site.',
            'notes':'Used for asymmetrical age uncertainties often calculated using Bayesian statistics when one has additional age constraints on the age of the site.',
            'examples':[
               '126.6',
               '514',
         ...
         'material':{
            'label':'Specimen Material Types',
            'group':'Geology',
            'position':38,
            'type':'List',
            'description':'Colon-delimited list of specimen material types',
            'examples':[
               'Pluton',
               'Lava Flow',
               'Amphora',
   ...
   'experiments':{
      ...
      'notes':'Resulting plateau, isochron and total fusion ages, experiment descriptions, and irradiation info',
      'columns':{
         'contribution_id':{
            'label':'Contribution ID',
            'group':'Contribution',
         ...
         '40ar_36ar_ratio':{
            ...
            'position':23,
            'type':'Number',
            'description':'⁴⁰Ar/³⁶Ar ratio determine from the isochron',
            'examples':[
               '297.0133084'
            ],
            'validations':[
   ...
   'measurements':{
      ...
      'columns':{
         ...
         'mdf_40ar_36ar_standard_ratio_one_sigma':{
            ...
            'position':24,
            'type':'Number',
            'description':'The standard deviation of the ⁴⁰Ar/³⁶Ar ratio of the standard',
            'validations':[
               'required()'
            ]
         },
         ...
         'j_value':{
            ...
            'notes':'J is the irradiation flux parameter with its value determined from measuring the ratio of radiogenic ⁴⁰Ar to ³⁹Ar generated by potassium decay from a specimen of known age (the age standard)',
            'validations':[
               'required()'
            ]
         },
