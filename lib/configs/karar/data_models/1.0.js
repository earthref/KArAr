...
export const model = {
	...
	'sites': {
		...
		'columns': {
			...
			'age_one_sigma_external_stderr': {
				'label': 'Age One Sigma Internal Standard Error',
				'group': 'Age',
				'position': 10,
				'type': 'Number',
				'unit': 'Custom',
				'description': 'Site age uncertainty, one sigma standard error of the external age. Uncertainties in the standard ages, decay constants, Argon rations for air, etc. included in the uncertainty of the age.',
				'examples': ['0.23', '850']
			},
			'age_one_sigma_internal_stderr': {
				'label': 'Age One Sigma External Standard Error',
				'group': 'Age',
				'position': 11,
				'type': 'Number',
				'unit': 'Custom',
				'description': 'Site age uncertainty, one sigma standard error of the internal age. Uncertianties in measurements and flux monitor values but not external uncertainties, are included.',
				'examples': ['0.212', '832']
			},
			'age_low': {
				'label': 'Younger Age',
